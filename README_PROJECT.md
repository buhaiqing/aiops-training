...
- **技术**: AutoGen/CrewAI, Function Calling
- **难度**: ⭐⭐⭐⭐⭐
- **时间**: 150-180 分钟
- **状态**: 规划中

#### 📝 Lab 7: ChatOps 集成 - 钉钉/企微机器人
...
Day 1 (全天):
  ...
  下午 (4h): Lab 2 - Isolation Forest

Day 2 (全天):
  上午 (3h): Lab 3 - LSTM 自动编码器
  下午 (4h): LLM 应用演示 (Lab 5/6/7)
```
...
aiops_training/
├── README.md                      # 本文件
├── traning_plan.md                # 培训方案详细说明
├── AI ops客户沟通记录整理.docx    # 需求文档
├── Labs/                          # 动手实验目录
